...
using User = Spark_SocialMediaApp.Models.User;
using Spark_SocialMediaApp.Models;
using Newtonsoft.Json.Serialization;

namespace Spark_SocialMediaApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [RegularExpression(@"^[a-zA-Z0-9_-]{3,20}$", ErrorMessage = "Username must be 3-20 characters, alphanumerical, dash and underscores only")]
            public string UserName { get; set; }

            [Required]
            [MinLength(2, ErrorMessage = "Display name have be at least 2 characters")]
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                int usernameCount = _db.Users.Count(usr => usr.UserName.ToUpper() == Input.UserName.ToUpper());
